...
class LoginPage extends StatelessWidget {
  ...
  void _handleLogin(BuildContext context) {
    ...
    if (email == 'fsocietybvr@gmail.com' && password == '12345678') {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 9, 155, 148), // Color de la barra de navegación
      ),
      body: Padding(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary: Color.fromARGB(255, 9, 155, 148), // Color de fondo del botón
              ),
            ),
            SizedBox(height: 10),
            TextButton(
              ...
              child: Text(
                'Registrarse',
                style: TextStyle(color: Color.fromARGB(255, 9, 155, 148)), // Color del texto del botón de registro
              ),
            ),
          ],
        ),
